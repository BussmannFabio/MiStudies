...
> ⚠️ **Os custos e margens abaixo são estimativas de referência, não um cálculo de custo real.** Os valores de custo por aula (~R$3/R$6/R$12), os custos fixos mensais e as margens de ~88–92% foram projetados sem levantar: (1) preço real e atual das ferramentas/APIs usadas, (2) um valor-hora real para o tempo dos sócios (hoje tratado como "R$0 em caixa", o que esconde o verdadeiro custo do serviço), e (3) o rateio de todos os custos fixos do negócio por aula produzida. Ver [15. Modelo de Custo e Precificação Real](15.%20Modelo%20de%20Custo%20e%20Precificação%20Real.md) — enquanto não estiver pronto, as margens desta página não devem ser lidas como número final.
...
> Detalhamento de custo por etapa do pipeline (Análise, Pesquisa, Geração do MD, Geração do HTML), comparação de cenários manual vs. automatizado (n8n + IA local) e a conclusão sobre por que isso não deve baratear o preço da aula: ver [13. Pipeline Manual de Entrega — seção 10](13.%20Pipeline%20Manual%20de%20Entrega.md#10-arquitetura-de-automação--plataformas-e-custos).
