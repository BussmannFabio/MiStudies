...
| 1.4 | Definir pipeline manual: receber PDF → analisar → produzir → revisar → publicar | `[X]` Feito — [produto/13. Pipeline Manual de Entrega.md](../03-operacao/pipeline-manual-de-entrega.md) | `P1` | Todos |
| 1.4b | Calcular custo real (bottom-up) e validar/ajustar preços do Catálogo | `[!]` Modelo concluído; decisão de preços pendente — [doc 15](../02-oferta-e-financeiro/modelo-de-custo-e-precificacao-real.md) | `P1` | Todos |
| 1.5 | Criar contrato simples / termos de serviço para professores piloto | `[X]` Minuta criada; revisão jurídica obrigatória — [doc 33](../06-legal/contrato-professores-piloto.md) | `P1` | Sócio 3 |
...
| 2.11 | Criar proposta comercial / pitch para apresentar a professores | `[X]` Pitch textual criado — [doc 31](../04-comercial/pitch-comercial.md); deck visual opcional | `P2` | Sócio 3 |
...
> Auditoria completa de frontend em `docs/07-tecnologia/auditorias/frontend-inconsistencias.md` · 9 itens · 3 resolvidos
