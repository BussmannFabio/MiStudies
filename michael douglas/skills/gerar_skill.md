...
> **Saídas:** arquivo `.md` de skill completo, salvo em `michael douglas/skills/`
...
- **Se o processo descrito já existir** (total ou parcialmente) em `skills/`, sinalize antes de criar — pode ser expansão, não skill nova
...
- [ ] A skill não duplica nenhuma já existente em `skills/`?
- [ ] O nome do arquivo foi sugerido para salvar em `michael douglas/skills/`?
