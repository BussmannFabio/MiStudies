...
|---|---|---|
| 09 | ICP — Perfil do Professor Ideal | Sem isso, a prospecção é no escuro |
| 10 | Pitch Comercial para Professores | Script para abordar os pilotos |
| 11 | Templates de Comunicação | E-mail, WhatsApp e LinkedIn prontos para usar |
| 12 | Pipeline Manual de Entrega | O que acontece depois que o professor assina |
| 13 | Contrato Simples / Termos de Serviço | Formalizar o acordo com pilotos |
...
| 15 | Proposta de Valor Detalhada | Value Proposition Canvas para professor e aluno |

### Prioridade 3 — Crescimento e posicionamento

| # | Documento | Por que importa |
|---|---|---|
| 16 | Análise de Concorrentes | Entender onde o MiStudies se diferencia |
| 17 | Guia de Social Media | Como a marca se comporta em Instagram e LinkedIn |
| 18 | Roadmap de Produto | Versão limpa do que será construído e quando |
...
5. Salve o resultado em `michael douglas/docs/[número]. [Nome].md`
6. Atualize o índice em `docs/00. Índice e Roadmap.md`

**Ordem sugerida de geração** (do mais urgente para o menos):
```
09 → ICP do professor          (antes de prospectar)
10 → Pitch comercial           (antes de abordar)
11 → Templates de comunicação  (antes de mandar mensagem)
12 → Pipeline de entrega       (antes de assinar piloto)
13 → Contrato simples          (antes de assinar piloto)
14 → Guia de produção          (antes de produzir a 1ª aula paga)
15 → Proposta de valor         (refinamento de comunicação)
16 → Análise de concorrentes   (posicionamento)
17 → Guia de social media      (quando começar a publicar)
18 → Roadmap de produto        (quando tiver os primeiros dados reais)
```
