...
|---|---|---|
| 15 | Modelo de Custo e Precificação Real | Os preços em vigor não têm base de custo real — risco de cobrar errado (para menos ou para mais) de professores de verdade |
...
| 13 | Pipeline Manual de Entrega | ✅ Feito — o que acontece depois que o professor assina |
...
```
15 → Modelo de custo real      (antes de cobrar de qualquer professor fora do teste interno)
