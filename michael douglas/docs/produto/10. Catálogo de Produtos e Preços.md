...
> ⚠️ **Preços ainda não validados por um cálculo de custo real.** Os valores abaixo (Setup, Aula, Hub) foram definidos por comparação de mercado e estimativa, não por um levantamento bottom-up de custo (tempo valorado + ferramentas + custos fixos do negócio). Até o [15. Modelo de Custo e Precificação Real](15.%20Modelo%20de%20Custo%20e%20Precificação%20Real.md) ser concluído, trate estes preços como hipótese a confirmar, não como número fechado — especialmente antes de assinar contratos de longo prazo com professores piloto.
