...
| # | Ação | Motivo |
|---|---|---|
| P0.1 | Criar `playbooks/skills/analisar_pdf_professor.md` | É o ponto de entrada de todo projeto B2B — sem ela, a análise do material do professor é ad hoc e inconsistente |
| P0.2 | Criar `playbooks/skills/briefing_professor.md` | Precede a análise — sem briefing estruturado, a análise começa do zero toda vez |
| P0.3 | Criar `playbooks/skills/produzir_aula.md` + `revisar_aula.md` | Pipeline de produção sem documentação = qualidade inconsistente entre projetos |
...
| P1.4 | Criar `playbooks/skills/gerar_metadados_acervo.md` + `checklist_publicacao.md` | Publicar conteúdo novo sem checklist = risco de inconsistência na taxonomia e nas URLs |
...
| P2.4 | Gerar documentos comerciais faltantes via `docs/prompts-documentos-pendentes.md` (ICP, Pitch, Templates) | `P2` |
